  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          ...
          .snapshots(),
      builder: (context, snapshotTests) {
        if (snapshotTests.connectionState == ConnectionState.waiting) {
          return const Center(
        ...
        return ListView.builder(
            itemCount: snapshotTests.data!['questions'].length,
            itemBuilder: (BuildContext context, int index) {
              print('test');
              return StreamBuilder(
                  stream: FirebaseFirestore.instance
                  .collection('questions')
                  .doc('${snapshotTests.data!['questions'][index]}')
                  .snapshots(),
                      ...
                      return Scaffold(
                        appBar: AppBar(
                          ...
                          iconTheme: const IconThemeData(
                            color: Color(
                                0xFF4091C6), // Define a cor do botão de voltar
                          ),
                          title: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    dbStore.setQuestion(snapshot.data!.id, snapshotTests.data!.id);
                                  },
                                  child: Container(
                                    height: 40,
                                    clipBehavior: Clip.antiAlias,
