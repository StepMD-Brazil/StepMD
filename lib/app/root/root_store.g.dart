...
mixin _$RootStore on _RootStoreBase, Store {
  ...
  late final _$loginAtom = Atom(name: '_RootStoreBase.login', context: context);
  ...
  @override
  set login(Map<String, dynamic>? value) {
  ...
  late final _$setUserAsyncAction =
      AsyncAction('_RootStoreBase.setUser', context: context);
